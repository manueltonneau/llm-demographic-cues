...
Outputs:
  - results/regressions_all_models/{model}/{task}/  (coefficients, summary, side-by-side)
"""
import os
import sys
import gc
...
from cues.paths import DATA_DIR, PROMPTS as PROMPT_DIR, RACE_PRED as RP_DIR, RESPONSES as RS_DIR, REGRESSIONS_ALL_MODELS as OUT_ROOT, FK_CACHE, require_dir, require_produced

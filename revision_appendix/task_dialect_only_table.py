...
`results_dialect_allmodels/dialect_allmodels_summary.csv`; it was omitted from the
...
SRC = os.path.join(REPL_DIR, "results_dialect_allmodels", "dialect_allmodels_summary.csv")
...
S = [
    ...
    "",
    "Source: replication/results_dialect_allmodels/dialect_allmodels_summary.csv",
    "        (replication/replicate_dialect_only_allmodels.py). Table -> task_dialect_only_table.tex",
]
summary = "\n".join(S)

"""Regenerate the three LLaMA-3.1 regression tables from results_paper/.
...
from cues_io import require_dir, require_file

HERE = os.path.dirname(os.path.abspath(__file__))
SRC  = os.path.join(HERE, "results_paper")
...
# lower precision. Only the LLaMA rows come from results_paper/; the OLMo-2 and
# GPT-5.2 rows come from results_all_models/ and are left alone.
